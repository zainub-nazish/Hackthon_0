...
Behavior:
  ...
  - Filters messages for keywords: urgent, invoice, payment, help
...
First run:
    ...
    Subsequent runs reuse the saved session from Logs/whatsapp_session/.
"""
...
SESSION_DIR = LOG_DIR / "whatsapp_session"
POLL_INTERVAL = 30  # seconds

KEYWORDS: frozenset[str] = frozenset({"urgent", "invoice", "payment", "help"})
...
class WhatsAppWatcher(BaseWatcher):
    ...
    Keyword triggers: urgent, invoice, payment, help
    """
